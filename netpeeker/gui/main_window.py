...
from ..util import human_speed, ports_str
...
class NetPeekierApp(tk.Tk):
    ...
    def _build_dashboard(self) -> None:
        ...
        def block(parent, title, now_var, peak_var, color):
        ...
        up = block(bar, "UPLOAD", self.var_up_now, self.var_up_peak, "#ffb454")
    ...
    def _build_app_list(self) -> None:
        ...
        self.tree.column("up", width=90, anchor="e")
        self.tree.column("down", width=90, anchor="e")
    ...
    def _update_tree(self, procs: List[ProcStat]) -> None:
        ...
        for name, members in sorted(
            ...
            vals = (human_speed(up), human_speed(down), ports_str(ports))
